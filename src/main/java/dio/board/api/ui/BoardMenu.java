...
import dio.board.api.dto.BoardColumnInfoDTO;
...
import dio.board.api.service.BoardColumnQueryService;
import dio.board.api.service.BoardQueryService;
import dio.board.api.service.CardQueryService;
import dio.board.api.service.CardService;
...
public class BoardMenu {
    ...
    private void showColumn() throws SQLException {
        var columnsIds = entity.getColumns().stream().map(BoardColumn::getId).toList();
